<?php
	...
	*/
	class PartTimeStudentTest extends TestCase{
		...
		*/
		function test_construct(){
            ...
            //Declare part-time student variable
            $id = "10290953";
			...
			$this->assertJson($result['majors'], "BIT");
			$this->assertJson($result['choices'], "20, 5, 18");
		...
		*/
		public function setUp() : void{
            ...
            if($this->account_type != 2){
				throw new Exception("Account is not a part time student.");
			}else{
		...
		function test_get_name(){
			return $this->assertEquals($this->name, "Gerri Lorincz");
		}
		...
		*/
		public function test_get_phone(){
			return $this->assertEquals($this->phone, "84933406");
		}
		...
		*/
		public function test_get_sim_email(){
			return $this->assertEquals($this->sim_email, "gerri.lorin@mymail.sim.edu.sg");
		}
		...
		*/
		public function test_get_personal_email(){
			return $this->assertEquals($this->personal_email, "gerri.lorin@live.com");
		}
		...
		*/
		public function test_get_type_int(){
			return $this->assertEquals($this->account_type, 2);
		}
		...
		*/
        public function test_is_part_time() {
            return $this->assertTrue($this->account_type == 2);
        }
		...
		*/        
        public function test_get_majors() {
            return $this->assertEquals($this->majors, "BIT");
        }        
		...
		*/        
        public function test_get_choices() {
            return $this->assertJson(json_encode($this->choices), "20, 5, 18");
        }     
